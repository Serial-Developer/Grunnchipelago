...
#
# "Polaroid: Demon" is DEAD CONTENT [J 2026-07-22, confirmed in-game + full-assembly
...
#
# "Polaroid: VoidSkeleton" is ALSO dead content [J 2026-07-27, confirmed in-game + code].
...
# "Polaroid: GardenGnomes" is dead content too [J 2026-07-27, proven in-game]. Its scene
...
# "Obtain OldKey" and "Obtain AbandonedKey" are NOT reachable checks [J 2026-07-27]:
# neither key is actually usable/pickable in the shipped game (OldKey was shelved from the
# item pool on Jonath's request; AbandonedKey is only used BY US, to lock the player hut -
...
# "Deed" checks (demande Jonath 2026-07-28): rewarded ACTIONS rather than pickups - use an
...
POLAROID_REGION: dict[str, str] = {
    ...
    # SPAWN SIDE, not the Exterieur [J 2026-07-31, confirmed in dump]: the polaroid sits
    ...
    # the bridge, exactly as Jonath describes.
...
def create_all_locations(world: "GrunnWorld") -> None:
    ...
    # exclude_bad_endings (demande Jonath 2026-07-30): drop the checks of the 8 endings
